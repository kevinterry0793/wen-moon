            ...
            if (c.length > 1) for (var d = 0, i = c.length; i > d; d++) eve.off(c[d], b);
                ...
                for (d = 0, i = c.length; i > d; d++)
                    for (p = 0; p < r.length; p += m.length - 2) {
                        if (((m = [p, 1]), (k = r[p].n), c[d] != h)) k[c[d]] && (m.push(k[c[d]]), s.unshift({ n: k, name: c[d] }));
        ...
        var c = (function (b) {
                var c,
                    ...
                    s = function (a, b, c, e, f, g, h) {
                        var j = { id: i(), start: a, end: b, b: c, s: 0, dur: e - c, spd: 1, get: f, set: g, easing: h || s.linear, status: k, speed: l, duration: m, stop: n, pause: o, resume: p, update: q };
                        d[j.id] = j;
                        var t,
                            u = 0;
                ...
                return (
                    ...
                    (s.elastic = function (a) {
                        return a == !!a ? a : Math.pow(2, -10 * a) * Math.sin(((a - 0.075) * (2 * Math.PI)) / 0.3) + 1;
                    }),
                    (s.bounce = function (a) {
                        var b,
                            c = 7.5625,
        ...
        return (
            d.plugin(function (c, d, e, f, g) {
                ...
                k.getBBox = function (a) {
                    ...
                    try {
                        return a
                            ? ((f.bboxwt = g ? c.path.getBBox((b.realPath = g(b))) : c._.box(b.node.getBBox())), c._.box(f.bboxwt))
                            : ((b.realPath = g(b)), (b.matrix = b.transform().localMatrix), (f.bbox = c.path.getBBox(c.path.map(b.realPath, d.add(b.matrix)))), c._.box(f.bbox));
                    } catch (h) {
                        return c._.box();
                    }
                };
                ...
                (k.transform = function (a) {
                    ...
                    return (
                        a instanceof c.Matrix ? ((this.matrix = a), (this._.transform = a.toTransformString())) : h(this, a),
                        this.node &&
                    ...
                    (k.pattern = k.toPattern = function (a, b, c, d) {
                        ...
                        return (
                            ...
                            o(e.node, { x: a, y: b, width: c, height: d, patternUnits: "userSpaceOnUse", id: e.id, viewBox: [a, b, c, d].join(" ") }),
                    ...
                    (k.marker = function (a, b, c, d, e, f) {
                        ...
                        return (
                            null == a && (a = this.getBBox()),
                            l(a, "object") && "x" in a && ((b = a.y), (c = a.width), (d = a.height), (e = a.refX || a.cx), (f = a.refY || a.cy), (a = a.x)),
                            o(g.node, { viewBox: [a, b, c, d].join(" "), markerWidth: c, markerHeight: d, orient: "auto", refX: e || 0, refY: f || 0, id: g.id }),
                    ...
                    (b.add = function (a, b, c, d, e, g) {
                        ...
                        (b.split = function () {
                            ...
                            var f = e[0][1],
                                g = e[1][1];
                            return (
                                0 > g ? ((b.rotate = a.deg(i.acos(g))), 0 > f && (b.rotate = 360 - b.rotate)) : (b.rotate = a.deg(i.asin(f))),
            ...
            d.plugin(function (c, d, e, f, g) {
                ...
                (h.rect = function (a, b, c, d, e, f) {
                    var g;
                    return null == f && (f = e), i(a, "object") && "[object Object]" == a ? (g = a) : null != a && ((g = { x: a, y: b, width: c, height: d }), null != e && ((g.rx = e), (g.ry = f))), this.el("rect", g);
                }),
                    (h.circle = function (a, b, c) {
                        var d;
                        return i(a, "object") && "[object Object]" == a ? (d = a) : null != a && (d = { cx: a, cy: b, r: c }), this.el("circle", d);
                    });
                var j = (function () {
                    function a() {
                ...
                (h.image = function (a, b, d, e, f) {
                    ...
                    (h.ellipse = function (a, b, c, d) {
                        var e;
                        return i(a, "object") && "[object Object]" == a ? (e = a) : null != a && (e = { cx: a, cy: b, rx: c, ry: d }), this.el("ellipse", e);
                    }),
                    (h.path = function (a) {
                        var b;
                    ...
                    (h.svg = function (a, b, c, d, e, f, g, h) {
                        ...
                        return (
                            i(a, "object") && null == b
                                ? (j = a)
                                : (null != a && (j.x = a), null != b && (j.y = b), null != c && (j.width = c), null != d && (j.height = d), null != e && null != f && null != g && null != h && (j.viewBox = [e, f, g, h])),
                            this.el("svg", j)
                        );
                    }),
                    (h.mask = function (a) {
                    ...
                    (function () {
                        ...
                        function j(a, b, h, i, j) {
                            ...
                            return (k.stops = d), (k.addStop = e), (k.getBBox = f), (k.setStops = g), null != b && l(k.node, { x1: b, y1: h, x2: i, y2: j }), k;
                        }
                        function k(a, b, g, h, i, j) {
                            var k = c._.make("radialGradient", a);
                            return (k.stops = d), (k.addStop = e), (k.getBBox = f), null != b && l(k.node, { cx: b, cy: g, r: h }), null != i && null != j && l(k.node, { fx: i, fy: j }), k;
                        }
                        var l = c._.$;
                ...
                (p.stroke = p.fill = "colour"),
                    ...
                    b.on("snap.util.equal", function (b, c) {
                        var d,
                            ...
                            f = r(this.attr(b) || ""),
                            s = this;
                        if ("colour" == p[b]) return (d = a.color(f)), (e = a.color(c)), { from: [d.r, d.g, d.b, d.opacity], to: [e.r, e.g, e.b, e.opacity], f: k };
                        if ("viewBox" == b) return (d = this.attr(b).vb.split(" ").map(Number)), (e = c.split(" ").map(Number)), { from: d, to: e, f: j };
            ...
            d.plugin(function (a, c, d, e) {
                ...
                (a.filter = {}),
                    ...
                    (a.filter.shadow = function (b, c, d, e, f) {
                        return (
                            null == f && (null == e ? ((f = d), (d = 4), (e = "#000")) : ((f = e), (e = d), (d = 4))),
                            null == d && (d = 4),
                            null == f && (f = 1),
                            null == b && ((b = 0), (c = 2)),
                            null == c && (c = b),
